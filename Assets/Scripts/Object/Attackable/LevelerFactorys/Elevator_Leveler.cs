...
{
    public class ElevatorFactory : LevelerFactory
    {
        public override IPhysicalAttackable CreateLeveler(LevelerController context)
        {
            return new Elevator_Leveler(context);
        }
    }
    public class Elevator_Leveler : IPhysicalAttackable
    {
        private readonly LevelerController _context;
        public Elevator_Leveler(LevelerController context)
        {
            _context = context;
        }
